      ...
      <div className="bg-white border border-[#E0DDDD] rounded-xl p-4 md:p-6 hidden md:block">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-gray-700">
            <thead>
              <tr className="border-b border-[#E0DDDD] text-[#1F1E1E]">
                <th className="py-3 px-4 text-left font-bold">Plan ID</th>
                <th className="py-3 px-4 text-left font-bold">Plan Name ↓</th>
                <th className="py-3 px-4 text-left font-bold">Duration ↓</th>
                <th className="py-3 px-4 text-left font-bold">Books Allowed ↓</th>
                <th className="py-3 px-4 text-left font-bold">Price ↓</th>
                <th className="py-3 px-4 text-left font-bold">Active Users ↓</th>
                <th className="py-3 px-4 text-left font-bold">Created On ↓</th>
            ...
            <tbody>
              {plans.map((plan, i) => (
                ...
                >
                  <td className="py-4 text-[#1F1E1E] font-medium px-4">{plan.id}</td>
                  <td className="py-4 px-4 font-medium text-[#6B7280]">{plan.name}</td>
                  <td className="py-4 px-4">{plan.duration}</td>
                  <td className="py-4 px-4">{plan.books}</td>
                  <td className="py-4 px-4">{plan.price}</td>
                  <td className="py-4 px-4">{plan.users}</td>
                  <td className="py-4 px-4">{plan.createdOn}</td>
                  ...
                  <td className="py-4 px-4 flex items-center gap-3">
                    ...
                    <button className="text-red-500 hover:text-red-700">
                                 <svg width="16" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
